...
@section('title', 'Detalles de la Lista de Requisitos')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <h3 class="text-xl font-bold mb-4">Requisitos solicitados por {{ $listasRequisito->user->name }}</h3>
                <div class="space-y-4">
                        ...
                        <a href="{{ route('requisitos.show', $requisito->id) }}"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    @if ($requisito->tipo_documento == App\Enums\TipoDocumentoEnum::DOCUMENTO)
                                        <i class="fas fa-file-alt text-blue-500 text-2xl"></i>
                                    @elseif ($requisito->tipo_documento == App\Enums\TipoDocumentoEnum::PDF)
                                        <i class="fas fa-file-pdf text-red-500 text-2xl"></i>
                                    @elseif ($requisito->tipo_documento == App\Enums\TipoDocumentoEnum::FOTO)
                                        <i class="fas fa-file-image text-gray-500 text-2xl"></i>
                                    @elseif ($requisito->tipo_documento == App\Enums\TipoDocumentoEnum::VIDEO)
